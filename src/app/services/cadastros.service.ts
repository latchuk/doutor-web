...
export class CadastrosService {
    ...
    private async cadastrarPerguntas() {
        ...
        await this.cadastrarPerguntasS002();
    ...
    /**
     * S002 - Acordando durante a noite.
     */
    private async cadastrarPerguntasS002() {
        ...
        const perguntas: Pergunta[] = [

            {
                id: 'p01_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Seu bebê tem menos de 3 meses?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
...

            {
                id: 'p02_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Seu bebê chora e tem dificuldade para dormir apenas à noite?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: 'd01_s002',
                        idProximaPergunta: null
                    },
                    {
                        id: 'nao',
...

            {
                id: 'p03_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Quando o seu bebê acorda você o alimenta?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: null,
                        idProximaPergunta: 'p04_s002'
                    },
                    {
                        id: 'nao',
                        texto: 'Não',
                        ordem: 2,
                        idDiagnostico: 'd03_s002',
                        idProximaPergunta: null
                    }
                ]
            },

            {
                id: 'p04_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Quando o seu bebê se alimenta, você volta a dormir?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: 'd02_s002',
                        idProximaPergunta: null
                    },
                    {
                        id: 'nao',
...

            {
                id: 'p05_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Antes seu bebê dormia bem durante a noite?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
...

            {
                id: 'p06_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Seu bebê parece não estar bem: por exemplo, sua temperatura marca 38ºC ou mais?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: 'd04_s002',
                        idProximaPergunta: null
                    },
                    {
                        id: 'nao',
...

            {
                id: 'p07_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Quando seu bebê acordou ele chorava muito, sendo difícil consolá-lo?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: 'd06_s002',
                        idProximaPergunta: null
                    },
                    {
                        id: 'nao',
...

            {
                id: 'p08_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'O seu bebê dorme no seu quarto?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: 'd05_s002',
                        idProximaPergunta: null
                    },
                    {
                        id: 'nao',
...

            {
                id: 'p09_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'O quarto em que o bebê dorme é frio e geralmente o bebê se descobre durante a noite?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: 'd07_s002',
                        idProximaPergunta: null
                    },
                    {
                        id: 'nao',
...

            {
                id: 'p10_s002',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Houve algum tipo de perturbação doméstica há pouco tempo, como uma mudança de casa ou ausência da mãe ou do pai?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
                        ordem: 1,
                        idDiagnostico: 'd08_s002',
                        idProximaPergunta: null
                    },
                    {
                        id: 'nao',
     ...
     * Sxxx - Exemplo.
     */
    private async cadastrarPerguntasSxxx() {
    ...
    private async cadastrarPerguntasS054() {
        ...
        const perguntas: Pergunta[] = [

            {
                id: 'p01_s054',
                // tslint:disable-next-line: max-line-length
                conteudo: 'Você se sente constantemente no "limite", com uma sensação de frio no estômago?',
                respostas: [
                    {
                        id: 'sim',
                        texto: 'Sim',
    ...
    private async cadastrarDiagnosticos() {
        ...
        await this.CadastrarDiagnosticosS002();
     ...
     * S002 - Acordando durante a noite.
     */
    private async CadastrarDiagnosticosS002() {
        ...
        const diagnosticos: Diagnostico[] = [

            {
                id: 'd01_s002',
                idCategoria: 'c1',
                titulo: 'Cólicas noturnas',
                // tslint:disable-next-line: max-line-length
                descricao: ' pode ser a causa da inquietação e do choro.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: null,
                idProximoSintoma: 's005_c1',
            },

            {
                ...
                titulo: 'A fome',
                // tslint:disable-next-line: max-line-length
                descricao: ' deve estar fazendo o seu bebê acordar. A necessidade de mais mamadas é normal em bebês dessa idade.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: 'Tentar impedir que o bebê acorde a noite por fome, oferecendo mais mamadas antes de você dormir, em geral não resolve. É melhor se habituar com a ideia de que você ainda tem várias semanas de sono perturbado pela frente e ajustar a sua rotina de acordo com a necessidade do bebê.\n' +
                    // tslint:disable-next-line: max-line-length
                    'Tente cochilar de dia, quando o bebê está dormindo. Se possível, os pais devem combinar turnos para acordar. Se o bebê mamar no peito, veja se consegue extrair leite para o pai dar na mamadeira durante a noite. Se você acha que a falta de sono está começando a afetar a sua saúde de modo geral ou a está deixando com raiva do bebê, consulte um médico.',
...

            {
                ...
                titulo: 'A fome',
                // tslint:disable-next-line: max-line-length
                descricao: ' é o motivo é o motivo mais plausível para a falta de sono do seu bebê.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: 'Oferecer alimentação para o bebê é o melhor meio de fazê-lo voltar a dormir.',
                idProximoSintoma: null,
            },

            {
                id: 'd04_s002',
                idCategoria: 'c1',
                titulo: 'Alguma doença',
                // tslint:disable-next-line: max-line-length
                descricao: ' pode estar fazendo o bebê acordar. Fique atento aos outros sintomas e procure um sintoma inicial adequado na lista de sintomas.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: null,
                idProximoSintoma: null,
            },

            {
                id: 'd05_s002',
                idCategoria: 'c1',
                titulo: 'Dividir o mesmo quarto',
                // tslint:disable-next-line: max-line-length
                descricao: ' pode resultar em noite desnecessariamente perturbadas para você e o bebê. Talvez você faça ruídos que o acordem ou, o que é mais provável, a proximidade a faz estar sempre alerta aos seus menores movimentos e imaginar que os pequenos ruídos que ele emite são sinais de despertar. Muitos bebês têm sono inquieto e, se ninguém os perturba, voltam a dormir facilmente.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: 'Se possível, passe o bebê para um outro quarto. Dificilmente você deixará de ouvir um choro de verdade e com certeza não terá o sono perturbado por sons menos urgentes.',
                idProximoSintoma: null,
            },

            {
                id: 'd06_s002',
                idCategoria: 'c1',
                titulo: 'A dor de ouvido,',
                // tslint:disable-next-line: max-line-length
                descricao: ' decorrente de uma possível infecção no ouvido médio, costumam fazer os bebês que antes dormiam bem acordarem chorando.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: null,
                idProximoSintoma: 's029_c2',
            },

            {
                ...
                titulo: 'O frio',
                // tslint:disable-next-line: max-line-length
                descricao: ' pode ser a causa de seu bebê estar acordando.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: 'Um bebê que se mexe muito durante o sono e chuta as cobertas para longe deve dormir mais aquecido. Coloque-o num saco de dormir ou vista um macacãozinho quente.',
                idProximoSintoma: null,
            },

            {
                ...
                titulo: 'A ansiedade',
                // tslint:disable-next-line: max-line-length
                descricao: ' pode prejudicar o sono de bebês mais novinhos. Mesmo pequenas alterações na rotina doméstica às vezes causam perturbação.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: 'Talvez leve vários dias para você fazer o bebê sentir que não existe motivo para ansiedade. Durante esse tempo tente impedir outras mudanças na rotina. Quando o bebê acordar no meio da noite, dê-lhe água ou chá para beber, abrace-o com carinho, mas ponha-o no berço sem demora. Sempre há o perigo de ele se acostumar a acordar e esperar brincadeiras.',
                idProximoSintoma: null,
            },

            {
                id: 'd09_s002',
                idCategoria: 'c1',
                titulo: 'A necessidade de conforto e de garantia da sua presença',
                // tslint:disable-next-line: max-line-length
                descricao: ' é a explicação mais comum para o bebê acordar durante a noite, uma vez que a fase das mamadas noturnas terminou.',
                // tslint:disable-next-line: max-line-length
                autoAjuda: 'Esforce-se o mais possível para estabelecer e manter a rotina de pôr o bebê na cama. Se ele acordar durante a noite, ofereça-lhe chá ou água, mas evite pegá-lo no colo. Fique com o bebê apenas o tempo necessário para mostrar que você está por perto e se certificar que não há nada de errado. Se o bebê chorar quando você estiver saindo do quarto, tente resistir à tentação de voltar. Chorar por alguns minutos antes de dormir não fará mal ao bebê.',
                idProximoSintoma: null,
            },
